...
import { useGetAllOrdersQuery, useGetMyOrdersQuery, useUpdateOrderStatusMutation } from '../api/sportshopApi';
          ...
          <div key={order.id} className="order-card">
            ...
            <div className="order-footer">
              ...
              {isAdmin && STATUS_NEXT[order.status] && (
                <button className="btn btn-outline btn-sm" onClick={() => handleStatusChange(order.id, STATUS_NEXT[order.status]!)}>
