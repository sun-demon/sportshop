...
import { useGetProductQuery, useDeleteProductMutation } from '../api/sportshopApi';
...
export default function ProductDetailPage() {
  ...
  if (isError || !product) return <div className="container"><div className="alert alert-error">Товар не найден</div></div>;
        ...
        <div className="product-detail-info">
          ...
          <div className="product-detail-actions">
            {product.stock > 0 && (isAuthenticated
              ? <button className="btn btn-primary" onClick={() => { dispatch(addToCart(product)); navigate('/cart'); }}>Добавить в корзину</button>
