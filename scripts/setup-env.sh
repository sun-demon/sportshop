...
echo -e " ${GREEN}./scripts/setup-admin.sh${NC} — при необходимости создать admin в БД"
echo -e " ${GREEN}docker compose down -v${NC} — остановить и удалить volumes"
echo -e " ${GREEN}docker compose logs -f${NC} — логи"
